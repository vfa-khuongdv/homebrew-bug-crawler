class BugCrawler < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/vfa-khuongdv/homebrew-bug-crawler/releases/download/1.0.1/bug-crawler-darwin-arm64"
      sha256 "9a1cc7e375f5a52c9a964902d46668a46ac632204ceee2d9ec29570afbf86036"
    end
    if Hardware::CPU.intel?
      url "https://github.com/vfa-khuongdv/homebrew-bug-crawler/releases/download/1.0.1/bug-crawler-darwin-amd64"
      sha256 "56d637e3f6c254e5497effe35272cc6ea6fe2f60a3bd076077971a7c35cd2937"
    end
  end

  on_linux do
    url "https://github.com/vfa-khuongdv/homebrew-bug-crawler/releases/download/1.0.1/bug-crawler-linux-amd64"
